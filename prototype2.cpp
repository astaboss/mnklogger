...
#define WM_USER_MOUSE_MOVE_EVENT (WM_USER + 3)
#define WM_USER_MOUSE_RESIZE_EVENT (WM_USER + 4)
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    hwndMain = CreateWindow("MyWindowClass", "My Window", WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, 800, 600, NULL, NULL, hInstance, NULL);
    ...
    hwndTextBox = CreateWindowEx(WS_EX_CLIENTEDGE, "EDIT", "", WS_CHILD | WS_VISIBLE | WS_BORDER | ES_READONLY | ES_AUTOVSCROLL | ES_AUTOHSCROLL | ES_MULTILINE | WS_VSCROLL, 10, 30, 360, 230, hwndMain, NULL, GetModuleHandle(NULL), NULL);
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    switch (msg) {
        ...
        // case WM_USER_MOUSE_MOVE_EVENT:
        //     {
        //         int xPos = LOWORD(lParam);
        //         int yPos = HIWORD(lParam);

        //         char text[100];
        //         sprintf_s(text, sizeof(text), "Mouse Logger Window has been moved to (%d, %d)\r\n", xPos, yPos);

        //         // Отримання довжини поточного тексту у текстовому полі
        //         int textLength = GetWindowTextLength(hwndTextBox);

        //         // Вставка тексту в текстове поле на новий рядок
        //         SendMessage(hwndTextBox, EM_SETSEL, textLength, textLength);
        //         SendMessage(hwndTextBox, EM_REPLACESEL, FALSE, (LPARAM)text);
        //     }
        // break;

        // case WM_USER_MOUSE_RESIZE_EVENT:
        //     {
        //         int width = LOWORD(lParam);
        //         int height = HIWORD(lParam);

        //         char text[100];
        //         sprintf_s(text, sizeof(text), "Mouse Logger Window has been resized to %dx%d\r\n", width, height);
...
LRESULT CALLBACK MouseLoggerProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    switch (msg) {
        ...
        // case WM_MOVE:
        //         {
        //         // Отримання координат нового положення вікна MouseLogger
        //         int xPos = LOWORD(lParam);
        //         int yPos = HIWORD(lParam);

        //         // Відправення повідомлення про переміщення головному вікну
        //         PostMessage(hwnd, WM_USER_MOUSE_MOVE_EVENT, 0, MAKELPARAM(xPos, yPos));
        //     }
        //     break;

        //     case WM_SIZE:
        //         {
        //             // Отримання нового розміру вікна MouseLogger
        //             int width = LOWORD(lParam);
        //             int height = HIWORD(lParam);

        //             // Відправлення повідомлення про зміну розміру головному вікну
        //             PostMessage(hwnd, WM_USER_MOUSE_RESIZE_EVENT, 0, MAKELPARAM(width, height));
        //         }
        //         break;
